...
private:
    ...
    using FnGetU64 = uint64_t (WA_CALL*)(void *);
    using FnGetI64 = int64_t (WA_CALL*)(void *);
    ...
    struct Loaded {
        ...
        FnGetU64 get_tick_count = nullptr;
        FnGetU64 get_read_count = nullptr;
        FnGetU64 get_request_count = nullptr;
        FnGetI64 get_last_tick_ms = nullptr;
