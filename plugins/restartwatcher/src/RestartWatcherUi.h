...
// Simple configuration UI for restartwatcher plugin.
// Discovered by the host via the optional export: wa_create_widget().
class RestartWatcherUi final : public QWidget {
public:
    explicit RestartWatcherUi(WaHostApi* api, QWidget* parent = nullptr);
