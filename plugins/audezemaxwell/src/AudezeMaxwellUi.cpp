...
QString AudezeMaxwellUi::configPath() {
...
bool AudezeMaxwellUi::saveToDisk() {
    ...
    if (!sf.open(QIODevice::WriteOnly)) {
        QMessageBox::warning(this, "Audeze", "Failed to open config file for writing.\n" + configPath());
        return false;
    }
    ...
    if (!sf.commit()) {
        QMessageBox::warning(this, "Audeze", "Failed to commit config file changes.\n" + configPath());
        return false;
    }
...
void AudezeMaxwellUi::refreshStatus() {
