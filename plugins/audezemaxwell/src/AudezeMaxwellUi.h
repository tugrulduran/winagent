...
// Simple configuration UI for audezemaxwell plugin.
// Discovered by the host via the optional export: wa_create_widget().
class AudezeMaxwellUi final : public QWidget {
public:
    explicit AudezeMaxwellUi(WaHostApi* api, QWidget* parent = nullptr);
